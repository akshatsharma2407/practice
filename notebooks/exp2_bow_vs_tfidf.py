...
with mlflow.start_run(run_name='all experiments') as parent:
    ...
    for algo_name, algo in algorithms.items():
        for vectorizer_name,vectorizer in vectorizers.items():
            ...
            with mlflow.start_run(run_name=f'{algo_name} with {vectorizer_name}',nested=True) as child:
                ...
                mlflow.log_param('vectorizor',vectorizer_name)
                ...
                print(f"Algorithm: {algo_name}, Feature Engineering: {vectorizer_name}")
